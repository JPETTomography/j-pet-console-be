...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_radioisotopes_id"), "radioisotopes", ["id"], unique=False
    )
    op.create_table(
        "tags",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_measurements_id"), "measurements", ["id"], unique=False
    )
    op.create_table(
        "comments",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "acquisition_date", sa.TIMESTAMP(timezone=True), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_data_entry_id"), "data_entry", ["id"], unique=False
    )
    op.create_table(
        "meteo_readouts",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_meteo_readouts_id"), "meteo_readouts", ["id"], unique=False
    )
    op.create_table(
        "radioisotope_measurement",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_radioisotope_measurement_id"),
        "radioisotope_measurement",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_tag_measurement_id"), "tag_measurement", ["id"], unique=False
    )
    op.create_table(
        "comment_pictures",
        sa.Column("id", sa.Integer(), nullable=False),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_comment_pictures_id"), table_name="comment_pictures"
    )
    ...
    op.drop_index(
        op.f("ix_radioisotope_measurement_id"),
        table_name="radioisotope_measurement",
    )
