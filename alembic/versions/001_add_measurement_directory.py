...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_measurement_directory_id'), 'measurement_directory', ['id'], unique=False)
    ...
    op.add_column('measurements', sa.Column('directory_id', sa.Integer(), nullable=True))
    ...
    op.create_foreign_key('fk_measurements_directory_id', 'measurements', 'measurement_directory', ['directory_id'], ['id'])
...
def downgrade() -> None:
    ...
    op.add_column('measurements', sa.Column('directory', sa.String(), nullable=True))
    ...
    op.drop_constraint('fk_measurements_directory_id', 'measurements', type_='foreignkey')
    op.drop_column('measurements', 'directory_id')
    
    # Drop measurement_directory table
    op.drop_index(op.f('ix_measurement_directory_id'), table_name='measurement_directory')
