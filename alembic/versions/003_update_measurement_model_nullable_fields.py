...
def upgrade() -> None:
    ...
    if 'description' in existing_columns and existing_columns['description'] == 'NO':
        op.alter_column('measurements', 'description',
                        existing_type=sa.String(),
                        nullable=True)

    if 'number_of_files' in existing_columns and existing_columns['number_of_files'] == 'NO':
        op.alter_column('measurements', 'number_of_files',
                        existing_type=sa.Integer(),
                        nullable=True)

    if 'patient_reference' in existing_columns and existing_columns['patient_reference'] == 'NO':
        op.alter_column('measurements', 'patient_reference',
                        existing_type=sa.String(),
                        nullable=True)

    if 'shifter_id' in existing_columns and existing_columns['shifter_id'] == 'NO':
        op.alter_column('measurements', 'shifter_id',
                        existing_type=sa.Integer(),
                        nullable=True)
...
def downgrade() -> None:
    ...
    op.add_column('measurements', sa.Column('directory', sa.String(), nullable=False))
