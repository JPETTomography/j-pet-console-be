...
class Experiment(Base):
    ...
    measurement_directories = relationship("MasurementDirectory", back_populates="experiment")
...
class Measurement(Base):
    ...
    directory = relationship("MeasurementDirectory", back_populate="measurement")
    directory_id = Column(Integer, ForeignKey("measurement_directory.id"), nullable=False)
...
class MeasurementDirectory(Base):
    ...
    experiment = relationship("Experiment", back_populates="measurement_directories")
